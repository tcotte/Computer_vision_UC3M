# USAGE
# python segment_video_test.py --model enet-cityscapes/enet-model.net --classes enet-cityscapes/enet-classes.txt --colors enet-cityscapes/enet-colors.txt --video videos/massachusetts.mp4 --output output/massachusetts_output.avi
...
import cv2
# import skvideo
# skvideo.setFFmpegPath("C:/Users/User/AppData/Local/Programs/Python/Python36/Lib/site-packages/skvideo/io")
import skvideo.io
...
# net = cv2.dnn.readNetFromCaffe("Model/deploy_DilatedNet.prototxt", args["model"])

# initialize the video stream and pointer to output video file

vs = cv2.VideoCapture(args["video"])
# skvideo.setFFmpegPath("C:\\Users\\User\\AppData\\Local\\Programs\\Python\\Python36\\Lib\\site-packages\\skvideo\\io\\")
# vs = skvideo.io.vread(args["video"])
writer = None
    ...
    if frame_counter > 650:
        ...
        if writer is None:
            ...
            if args["output"] is None:
                path_video = args["video"].split('/')
                video_name = path_video[-1].split('.')
                writer = cv2.VideoWriter("videos/Output/" + video_name[0] + "_20fps.avi", fourcc, 20,
